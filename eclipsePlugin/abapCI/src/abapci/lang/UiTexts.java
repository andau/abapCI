...
public final class UiTexts {
	...
	public static final String LABEL_ACTION_UPDATE_PACKAGE = "Update package";
	...
	public static final String LABEL_ACTION_ADD_COLORED_PROJECT = "Add coloring for project";
	public static final String LABEL_ACTION_UPDATE_COLORED_PROJECT = "Update coloring for project";
	public static final String LABEL_ACTION_REMOVE_COLORED_PROJECT = "Remove coloring for project";
