...
public class FeatureCreatorTest {
	...
	@Test
	public void testColorChangerFeature() {
		
		cut.createColorChangerFeature(); 
		Mockito.verify(prefs, times(1)).getBoolean(PreferenceConstants.PREF_CHANGE_COLOR_ON_FAILED_TESTS); 
		Mockito.verify(prefs, times(1)).getBoolean(Mockito.any(String.class)); 
